...
#define CONFIG_BOOTARGS "totalmem=64M mem=40M phyaddru=0 phyaddrd=1 console=ttyAMA0,115200 root=/dev/mtdblock4 rootfstype=squashfs,jffs2 mtdparts=hi_sfc:192k(boot),64k(env),64k(tech),2048k(kernel),5120k(rootfs),-(rootfs_data)"
