...
gpio_init() {
	...
	hi3518ev200)
		...
		devmem 0x200f00e4 32 0x00  && echo " | GPIO7_1 | GPIO57 |           | Board                                            | SoC hi3518ev200 | " | logger -t gpio_init
		devmem 0x200f00f0 32 0x01  && echo " | GPIO7_4 | GPIO60 |           | Board                                            | SoC hi3518ev200 | " | logger -t gpio_init
		#
